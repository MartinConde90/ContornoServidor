...
if ($_SERVER["REQUEST_METHOD"]== "POST" && isset($_POST["id"]) ) {
        ...
        $libro = new Libro($id,$autor,$title,$genre,$price,$publish_date,$description);

        $xmlLibros = XmlLibro::appendLibro($xmlLibros,$libro);
        $xmlLibros->save(dirname(__FILE__)."/books.xml");
    }

    $xmlLibros = XmlLibro::transformar($xml,$xslt);
...
<div class="contenedor">
        ...
        <form action="" method="post">
            ...
            <input class="inpt" type="text" name="fecha_publicacion" id="fecha_publicacion" required placeholder="2023-05-09" >
