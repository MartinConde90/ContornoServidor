...
if(isset($_POST['create_post'])){
    $post_title        = escape($_POST['title']);
            ...
            $post_content      = strip_tags(escape($_POST['post_content']));
    ...
    $query .= "VALUES( '{$post_category}','{$post_title}','{$post_user}',now(),
    ...
    $create_post_query = mysqli_query($connection, $query);
        ...
        $the_post_id = mysqli_insert_id($connection); //Devuelve el id autogenerado que se utilizó en la última consulta
