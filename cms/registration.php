...
?>
 ...
 <?php
 //if($_SERVER['REQUEST_METHOD'] == "POST")  mejor forma de hacerlo
if(isset($_POST['register'])){
    ...
    if(emailNameRep($email)){
        $error['email'] = 'Already exists an account with this email, <a href="index.php">Please login</a>';
    }
