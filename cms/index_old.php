        ...
        <div class="row">
            ...
            $select_all_post_query = mysqli_query($connection, $query);
                ...
                while($row = mysqli_fetch_assoc($select_all_post_query)){
                    ...
                    $post_content = substr($row['post_content'],0,100); //de 0 caracteres a 100
            ...
            ?>
                        ...
                        <p class="lead">
                            by <a href="author_posts.php?author=<?php echo $post_author ?>&p_id=<?php echo $post_id ?>"><?php echo $post_author ?>
                        </p>
